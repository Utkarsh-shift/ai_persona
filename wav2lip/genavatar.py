...
def video2imgs(vid_path, save_path, ext = '.png',cut_frame = 10000000):
    ...
    while True:
        ...
        ret, frame = cap.read()
        if ret:
            cv2.putText(frame, "Placecom", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (128,128,128), 1)
...
def face_detect(images):
    ...
    results = [[image[y1: y2, x1:x2], (y1, y2, x1, x2)] for image, (x1, y1, x2, y2) in zip(images, boxes) if (x2 - x1) > 0 and (y2 - y1) > 0]
...
if __name__ == "__main__":
    ...
    for frame,coords in face_det_results:    
        ...
        print("appending at ",face_imgs_path,coords_path)
